  ...
  const [products, setProducts] = useState([
    {
      ...
      description: 'Camiseta 100% algodão com estampa do Darth Vader',
      sku: 'SW-DV-001',
      sales: 142,
    },
    {
      ...
      status: 'active',
      image: '/placeholder.svg?height=80&width=80',
      description: 'Action figure articulado do Homem-Aranha com 30cm',
      sku: 'AF-SM-001',
      sales: 128,
    },
    {
      ...
      status: 'out_of_stock',
      image: '/placeholder.svg?height=80&width=80',
      description: 'Caneca de porcelana com estampa Rick and Morty',
      sku: 'MG-RM-001',
      sales: 113,
    },
    {
      ...
      status: 'active',
      image: '/placeholder.svg?height=80&width=80',
      description: 'Funko Pop da personagem Eleven de Stranger Things',
      sku: 'FP-ST-011',
      sales: 98,
    },
    {
      ...
      status: 'active',
      image: '/placeholder.svg?height=80&width=80',
      description: 'Quadro decorativo do Batman em MDF',
      sku: 'QD-BT-001',
      sales: 67,
    },
    {
      ...
      status: 'active',
      image: '/placeholder.svg?height=80&width=80',
      description: 'Chaveiro do personagem Groot dos Guardiões da Galáxia',
      sku: 'CH-GR-001',
      sales: 89,
    },
    {
      ...
      status: 'active',
      image: '/placeholder.svg?height=80&width=80',
      description: 'Kit inicial do jogo de RPG Dungeons & Dragons',
      sku: 'JG-DD-001',
      sales: 34,
    },
    {
      ...
      status: 'inactive',
      image: '/placeholder.svg?height=80&width=80',
      description: 'Camiseta com logo da Dunder Mifflin Paper Company',
      sku: 'SW-TO-001',
      sales: 56,
    },
  ])

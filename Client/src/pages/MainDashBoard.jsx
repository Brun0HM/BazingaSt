...
export default function MainDashBoard() {
  ...
  const popularProducts = [
    ...
    {
      name: "Caneca Personalizada Rick and Morty",
      sales: 113,
      stock: 42,
      price: "R$ 49,90",
      image: "/placeholder.svg?height=60&width=60",
                  ...
                  <div className="card border-start border-2 border-primary">
                    <div className="card-body">
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <i
                          className="bi bi-currency-dollar text-muted"
                  ...
                  <div className="card border-start border-2 border-danger">
                    <div className="card-body">
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <i
                          className="bi bi-box2 text-muted"
                          style={{ fontSize: "1.25rem" }}
                        />
                      </div>
                  ...
                  <div className="card h-100">
                    <div className="card-header bg-white">
                      ...
                      <small className="text-muted">
                        Você recebeu 30 pedidos neste mês
                      </small>
                    </div>
                    <div
                      ...
                      {popularProducts.map((product) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              {product.sales} vendas · {product.stock} em
                              estoque
                            </p>
                          </div>
          ...
          {activeTab === "analytics" && (
            <div className="card">
              <div className="card-header bg-white">
                ...
                <small className="text-muted">
                  Visualize métricas avançadas da sua loja
                </small>
              </div>
              <div
              ...
              >
                <div className="text-center text-muted">
                  ...
                  <p>
                    Esta seção estará disponível em breve com métricas
                    detalhadas.
                  </p>
                </div>
              </div>

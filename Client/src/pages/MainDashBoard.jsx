...
<div className='ms-3 me-3'>
      ...
      <div className="flex-grow-1 p-4">
        ...
        <ul className="nav nav-tabs mb-4" id="dashboardTabs" role="tablist">
          ...
          <li className="nav-item" role="presentation">
            <button className="nav-link disabled" type="button">Relatórios</button>
          </li>
          <li className="nav-item" role="presentation">
            <button className="nav-link disabled" type="button">Notificações</button>
          </li>
        </ul>
              ...
              <div className="row g-4 mb-4">
                ...
                <div className="col-12 col-lg-6">
                  <div className="card h-100">
                    ...
                    <div className="card-footer bg-white">
                      <button className="btn border text-dark fw-semibold w-100">Ver todos os pedidos</button>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-12 col-lg-6">
                  <div className="card h-100">
                    ...
                    <div className="card-footer bg-white">
                      <button className="btn border text-dark fw-semibold w-100">Ver todos os produtos</button>
                    </div>
                  </div>
                </div>
              </div>
